...
```bash
-e trusted_peers=="1.2.3.4:9678,4.3.2.1:9678"
```

At this time, only IP addresses are supported. Domains will not be added to your config as a trusted peer.

See the [trusted peer documentation](https://docs.chiknetwork.com/faq/?_highlight=trusted#what-are-trusted-peers-and-how-do-i-add-them) to understand what trusted nodes are.
